...
execute:
  echo: true                 # show code
  warning: false             # hide knitr warnings
  message: false             # hide package startup messages
---

::: {.callout-note collapse="true" title="Secondary‑axis: why the hydrograph was flat"}
...
grammar simple and guards against misleading charts—at the cost of annoyances and manual work when forcing it to do dual axes.
